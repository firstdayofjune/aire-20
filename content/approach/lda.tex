...
\begin{figure}[bht]
    \subfigure[LDA Plot with colors to topics\label{fig:lda-tf-idf-topics}]{\includegraphics[width=0.49\textwidth]{figures/lda-tf-idf.pdf}}
    \subfigure[LDA Plot with colors for domains\label{fig:lda-tf-idf-domains}]{\includegraphics[width=0.49\textwidth]{figures/lda-domains.pdf}}
